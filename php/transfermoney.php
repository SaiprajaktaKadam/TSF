...
<body>
                        ...
                        <tbody>
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td class="center"><a href="userdetails.php?c_id=<?php echo $rows['c_id']; ?>"> <button type="button" class="btn ">Transfer Money</button></a></td>
                                    </tr>
                            <?php
                                }
                            }
  ...
  <footer class="center footer">
    <h6 class="info"><b>#GRIPMARCH2022 &copy Saiprajkta Kadam </b></h6>
